export default function CallToActionBottom() {
  return (
    <section className="text-gray-600 body-font bg-call-to-action flex-col-reverse md:flex-col">
      <div className="container mx-auto flex px-5 py-15 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font lg:text-6xl sm:text-4xl text-3xl mt-10 md:mt-auto mb-4 text-blue-300 font-medium title-font">
